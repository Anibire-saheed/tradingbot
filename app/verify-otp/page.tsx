        ...
        <div className="mx-auto flex w-full max-w-lg flex-col justify-center px-3 py-6 sm:px-8 lg:py-5">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mt-3 text-[15px] md:text-base text-neutral-600">
              Enter the verification code sent to your email to activate your account and access your dashboard.
            </p>
          </div>

          <Suspense fallback={<div className="py-8 text-center text-sm text-slate-400">Loading form...</div>}>
            <VerifyOtpForm />
          </Suspense>
