...
//   onBack: () => void;
//   onClose: () => void;
//   onSuccess: () => void; // Added property to fix the TypeScript error
// }
...
export function ImportWalletView({
  ...
  return (
    <section className="bg-white text-slate-900">
      ...
      <footer className="mt-6 flex items-center justify-center gap-2 border-t border-slate-100 pt-4 text-center text-[10px] text-slate-500">
        <ShieldCheck
          className="size-4 shrink-0 text-blue-600"
          aria-hidden="true"
        />
