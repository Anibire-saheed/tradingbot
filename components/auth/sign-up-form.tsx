...
export function SignUpForm() {
  ...
  const fields = [
    { key: "name", label: "Full name", autoComplete: "name", placeholder: "Your full name" },
    { key: "email", label: "Email", autoComplete: "email", placeholder: "you@example.com" },
    { key: "password", label: "Password", autoComplete: "new-password", placeholder: "Create a password" },
    { key: "confirmPassword", label: "Confirm password", autoComplete: "new-password", placeholder: "Confirm your password" },
  ] as const;
